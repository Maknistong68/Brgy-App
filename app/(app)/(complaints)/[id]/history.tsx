...
import { getStatusHistory } from '@/services/complaint';
import { Button, LoadingSpinner } from '@/components/ui';
import { colors, spacing, borderRadius, fontSize, fontWeight, shadows } from '@/theme';
import { formatDateTime, getStatusLabel } from '@/utils/format';
import { getStatusColor } from '@/utils/status';
import type { ComplaintStatusHistory, Profile } from '@/types';

// ---------------------------------------------------------------------------
// Types
// ---------------------------------------------------------------------------

type HistoryEntry = ComplaintStatusHistory & {
    ...
    return (
      <View style={styles.centerContainer}>
        ...
        <Text style={styles.emptySubtitle}>
          No status changes have been recorded for this complaint yet.
        </Text>
